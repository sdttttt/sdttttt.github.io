...
import { hash, pick, escapeXml, slugFromFilename, genSvg, patternCircleGrid, patternDiagonal, patternConcentric, patternTriangles, patternWave, patternDots, parseArgs as parseGenCoversArgs, listPosts, readPost, ensureDir, injectCoverField, generateFor, } from '../gen-covers.js';
...
describe('listPosts', () => {
    test('返回排序后的 Markdown 文件，排除 _index.md', () => inTempDir(async () => {
...
describe('readPost', () => {
    test('解析 front matter 并返回 slug', () => inTempDir(async () => {
        mkdirSync('content/posts', { recursive: true });
...
describe('injectCoverField', () => {
    ...
    test('dry-run 不写入', () => inTempDir(async () => {
        mkdirSync('content/posts', { recursive: true });
        const original = '---\ntitle: Hello\n---\n';
...
describe('generateFor', () => {
    test('无 cover 生成 SVG', () => inTempDir(async () => {
        mkdirSync('content/posts', { recursive: true });
