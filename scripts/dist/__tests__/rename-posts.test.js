...
import { normalizeDate, extractBody, computeHash6, rewriteCoverImage, buildReport, detectCollisions, } from '../rename-posts.js';
import { expect } from './expect.js';
// 模拟脚本对 raw 的处理：先用 extractBody 取 body，再算 hash
function simulateNewName(date, body) {
    const raw = `---\ndate: ${date}\n---\n${body}`;
