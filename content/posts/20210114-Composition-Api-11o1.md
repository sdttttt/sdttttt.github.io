...
date: 2021-01-14
description: "介紹在 Vue2 項目中以插件形式使用組合式 API 的寫法,演示類似 React 鉤子的自定義函數封裝與響應式數據拆分,討論初始化函數中無法使用 this 時通過獲取當前實例等方式訪問實例代理的解決辦法,以及自動追蹤副作用首次執行收集依賴的實現原理。"
tags: ["學習"]
author: sdttttt
draft: false
cover:
  image: "images/covers/20210114-Composition-Api-11o1.svg"
  alt: ""
  hidden: false
