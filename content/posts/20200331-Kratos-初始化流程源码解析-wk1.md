...
date: 2020-03-31
description: "从 main 入口出发逐层分析 bilibili Kratos 框架的初始化过程,包括 wire 依赖注入、gRPC 和 HTTP 服务注册等。"
draft: false
tags: ["学习"]
cover:
  image: "images/covers/20200331-Kratos-初始化流程源码解析-wk1.svg"
  alt: ""
  hidden: false
...
接下来我们首先看看`serviceService`是个什么东西._(这是什么魔鬼命名)_
